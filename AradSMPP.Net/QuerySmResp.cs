...
public class QuerySmResp : Header, IPacket, IPduDetails
{
    ...
    public DateTime FinalDate
    {
        ...
        set => FinalDateString = value.ToString("yyMMddHHmmss", CultureInfo.InvariantCulture);
    }
    ...
    {
        return new(defaultEncoding, commandStatus, querySm.Sequence, querySm.MessageId);
    }
    ...
    {
        QuerySmResp? querySmResp = new(defaultEncoding);
